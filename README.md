...
* Built a machine learning model to classify customer reviews into sentiment categories (positive, neutral, negative).
* Used techniques like data preprocessing, feature extraction, and classification algorithms.

### 🔹 Secure Email Communication

* Developed a system to send and receive encrypted emails using modern cryptographic techniques.
* Ensures data confidentiality and secure communication between users.
